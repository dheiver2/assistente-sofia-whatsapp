        ...
        <div className="sidebar-header">
          {isCollapsed ? (
            ...
            <div className="sidebar-brand">
              <img src="/brand-logo.svg" alt="Mangaba Vendas" className="sidebar-wordmark logo-light" />
              <img src="/brand-logo-dark.svg" alt="Mangaba Vendas" className="sidebar-wordmark logo-dark" />
